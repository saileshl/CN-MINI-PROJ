...
\usepackage{lmodern}
\usepackage[margin=1in, top=0.9in, bottom=0.9in, left=1in, right=1in, headheight=15pt, footskip=0.4in]{geometry}
\usepackage{graphicx}
\usepackage{grffile}
...
% -------------------------------------------------------------
% Typography & Formatting Customizations
% -------------------------------------------------------------
\onehalfspacing
\renewcommand{\arraystretch}{1.25}

% Column Aliases for Perfect Alignment
\newcolumntype{L}{>{\raggedright\arraybackslash}X}
\newcolumntype{C}{>{\centering\arraybackslash}X}

% Section and Chapter Heading Formats
\titleformat{\chapter}[display]
{\normalfont\LARGE\bfseries\centering}{\chaptertitlename\ \thechapter}{10pt}{\LARGE\uppercase}
...
% =============================================================
% TITLE PAGE (Strictly Fits Exactly on Page 1)
% =============================================================
\begin{titlepage}
    \thispagestyle{empty}
    \centering
    ...
    {\large\bfseries 2117240020329\par}
    ...
    \vspace{0.15cm}
    {\normalsize KUTHAMBAKKAM, CHENNAI -- 600 124\par}
    \vspace{0.15cm}
...
\begin{xltabular}{\textwidth}{|c|p{2.8cm}|c|L|}
\hline
...
\begin{enumerate}
    ...
    \item \textbf{Visual Telemetry Gaps:} Existing command-line tools output static terminal summaries without real-time, interactive playout waveform visualization.
\end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{pipeline_flowchart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{jitter_buffer_flowchart.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{use_case_diagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{dashboard_live.png}
    \caption{Live Network Jitter Dashboard with 60\,FPS Catmull-Rom Cubic Spline Telemetry Charts (Full HD Desktop PC View)}
    \label{fig:dash_screen}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{results_comparison.png}
    \caption{Paired A/B Experiment Comparison Table Showing 82.7\% Delivery Variance Reduction (Full HD Desktop PC View)}
    \label{fig:results_screen}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{setup_guide.png}
    \caption{A-to-Z Step-by-Step Agent Setup and Session Pairing Code Interface (Full HD Desktop PC View)}
    \label{fig:setup_screen}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{terminal_output.png}
